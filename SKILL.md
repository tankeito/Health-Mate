...
**用户**：
```
我是东东，男，34 岁，身高 172cm，现在 65kg，目标 64kg，有胆结石，不吃海鲜
```
...
| 版本 | 日期 | 更新内容 |
|------|------|---------|
| **v5.0.0** | 2026-03-14 | AI 点评 + 动态方案 + 过饱系数 + 症状惩罚 |
| **v4.0.0** | 2026-03-13 | 大模型集成 + Tavily 搜索 + JSON 解析优化 |
| **v3.0.0** | 2026-03-12 | 完整数据解析 + 运动加分项 |
| **v2.0.0** | 2026-03-10 | 运动维度 + 自定义权重 |
| **v1.0.0** | 2026-03-08 | 初始版本（饮食/饮水/体重） |
