...
LANGUAGE_LABELS = {"zh-CN": "中文", "en-US": "English"}
...
condition_summary = "、".join(CONDITION_LABELS[locale][item] for item in conditions) if locale == "zh-CN" else ", ".join(CONDITION_LABELS[locale][item] for item in conditions)
